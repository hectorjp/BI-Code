USE [master]
GO
/****** Object:  Database [AdventureWorksDW2016]    Script Date: 4/2/2018 8:29:25 PM ******/
CREATE DATABASE [AdventureWorksDW2016]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AdventureWorksDW2016_Data', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\AdventureWorksDW2016_Data.mdf' , SIZE = 174080KB , MAXSIZE = UNLIMITED, FILEGROWTH = 16384KB )
 LOG ON 
( NAME = N'AdventureWorksDW2016_Log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\AdventureWorksDW2016_Log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 16384KB )
GO
ALTER DATABASE [AdventureWorksDW2016] SET COMPATIBILITY_LEVEL = 130
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [AdventureWorksDW2016].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [AdventureWorksDW2016] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET ANSI_NULLS ON 
GO
ALTER DATABASE [AdventureWorksDW2016] SET ANSI_PADDING ON 
GO
ALTER DATABASE [AdventureWorksDW2016] SET ANSI_WARNINGS ON 
GO
ALTER DATABASE [AdventureWorksDW2016] SET ARITHABORT ON 
GO
ALTER DATABASE [AdventureWorksDW2016] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [AdventureWorksDW2016] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [AdventureWorksDW2016] SET CONCAT_NULL_YIELDS_NULL ON 
GO
ALTER DATABASE [AdventureWorksDW2016] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET QUOTED_IDENTIFIER ON 
GO
ALTER DATABASE [AdventureWorksDW2016] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET  DISABLE_BROKER 
GO
ALTER DATABASE [AdventureWorksDW2016] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [AdventureWorksDW2016] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [AdventureWorksDW2016] SET  MULTI_USER 
GO
ALTER DATABASE [AdventureWorksDW2016] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [AdventureWorksDW2016] SET DB_CHAINING OFF 
GO
ALTER DATABASE [AdventureWorksDW2016] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [AdventureWorksDW2016] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [AdventureWorksDW2016] SET DELAYED_DURABILITY = DISABLED 
GO
EXEC sys.sp_db_vardecimal_storage_format N'AdventureWorksDW2016', N'ON'
GO
ALTER DATABASE [AdventureWorksDW2016] SET QUERY_STORE = OFF
GO
...
USE [AdventureWorksDW2016]
GO
/****** Object:  UserDefinedFunction [dbo].[udfBuildISO8601Date]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[udfMinimumDate]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[udfTwoDigitZeroFill]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimCustomer]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimDate]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimGeography]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimProduct]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimProductCategory]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimProductSubcategory]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimSalesTerritory]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactInternetSales]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vDMPrep]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vTimeSeries]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vTargetMail]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vAssocSeqOrders]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vAssocSeqLineItems]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AdventureWorksDWBuildVersion]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DatabaseLog]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimAccount]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimCurrency]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimDepartmentGroup]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimEmployee]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimOrganization]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimPromotion]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimReseller]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimSalesReason]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DimScenario]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactAdditionalInternationalProductDescription]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactCallCenter]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactCurrencyRate]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactFinance]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactInternetSalesReason]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactProductInventory]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactResellerSales]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactSalesQuota]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FactSurveyResponse]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NewFactCurrencyRate]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProspectiveBuyer]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [AK_DimCurrency_CurrencyAlternateKey]    Script Date: 4/2/2018 8:29:25 PM ******/
...
GO
/****** Object:  Index [IX_DimCustomer_CustomerAlternateKey]    Script Date: 4/2/2018 8:29:25 PM ******/
CREATE UNIQUE NONCLUSTERED INDEX [IX_DimCustomer_CustomerAlternateKey] ON [dbo].[DimCustomer]
(
	[CustomerAlternateKey] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
/****** Object:  Index [AK_DimDate_FullDateAlternateKey]    Script Date: 4/2/2018 8:29:25 PM ******/
...
GO
/****** Object:  DdlTrigger [ddlDatabaseTriggerLog]    Script Date: 4/2/2018 8:29:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [AdventureWorksDW2016] SET  READ_WRITE 
GO
